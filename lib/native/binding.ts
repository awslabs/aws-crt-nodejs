...
//                 this.log(`NEW id: ${async_id} type: ${handle.type} resource: ${inspect(handle.resource)} execution_id: ${handle.execution_id}`);
//             },
//             destroy: (async_id) => {
//                 if (this.ignore) return;
//                 const handle = this.active_handles.get(async_id);
//                 if (handle) {
//                     this.log(`DEL id: ${async_id} type: ${handle.type} resource: ${inspect(handle.resource)} execution_id: ${handle.execution_id}`);
...
//                 this.log(`HANDLE: type: ${handle.type} resource: ${inspect(handle.resource)} execution_id: ${handle.execution_id}`);
//             }
//         }
