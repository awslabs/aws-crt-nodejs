...
int aws_napi_metrics_parse(
    ...
    if (napi_get_named_property(env, node_metrics, "libraryName", &node_library_name) != napi_ok ||
    ...
    if (napi_get_named_property(env, node_metrics, "metadata", &node_metadata) != napi_ok ||
